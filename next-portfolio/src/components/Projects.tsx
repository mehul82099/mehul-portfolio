        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((proj, i) => (
              <div 
                key={i} 
                className="group relative flex flex-col p-8 h-[450px] rounded-3xl bg-[#1a1715] border border-white/5 overflow-hidden transition-all duration-500 hover:border-orange-500/30 hover:bg-[#1f1b18]"
              >
                ...
                <div className="relative z-10 flex-grow">
                  ...
                  <p className="text-orange-400/80 font-medium mb-6">{proj.desc}</p>
                ...
                <div className="relative z-10 mt-auto flex justify-between items-end">
                  <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:bg-orange-500 group-hover:text-black group-hover:border-orange-500 transition-all duration-300">
